    ...
    <div className="manual-view">
      ...
      <aside className="mv-toc">
        ...
        <div className="mv-toc-tip">
          ...
          <div>
            <strong>Dica</strong>
            <span>O conteúdo completo abre no NotebookLM. Para ter acesso, faça o login com seu e-mail Google.</span>
          </div>
        </div>
      </aside>
      ...
      <article className="mv-main">
        ...
        <div className="mv-callout">
          ...
          <div>
            ...
            <p>Ao abrir o manual, você será direcionado ao NotebookLM, que funciona como um assistente de leitura com IA. Além de ler o conteúdo, você pode fazer perguntas diretamente sobre a rotina, como <em>"Qual o procedimento correto neste caso?"</em> ou <em>"Quais os passos para emissão do boleto?"</em>. O sistema responde com base exatamente no que está naquele manual. É um apoio rápido para consultas operacionais do dia a dia.</p>
          </div>
        </div>
      </article>
